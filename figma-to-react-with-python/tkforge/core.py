...
def download_image(file: str, id: str, name: str, token: str, out: str = None, frame: int = None) -> str:
    ...
    while retry_count < max_retries:
        try:
            ...
            time.sleep(0.5)  # Add import time at top of file
            ...
            if image_url:
                ...
                folder_path = os.path.join(out, 'ReactApp/src/assets', f'frame_{frame}') if frame is not None else os.path.join(out, 'ReactApp/src/assets')
                ...
                # Return relative path for React imports
